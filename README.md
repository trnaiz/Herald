...
# Herald
An Android application designed to monitor the health status of various services.
...
Search (Magnifying Glass): This allows you to search for a specific service and sort the list by name or status.
